...
export const codeLoggerPlugin = `import type { Plugin, PointGrabAPI } from 'pointgrab';
...
export const codeRegistration = `import { init } from 'pointgrab';
...
export const codeInit = `import { init } from 'pointgrab';
